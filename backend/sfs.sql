...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 04-07-2016 a las 13:55:11
...
(1, 'Cámaras de seguridad', 'Cámaras de seguridad'),
(2, 'Cámaras IP', 'Cámaras IP'),
(3, 'Cámaras HDCVI', 'Cámaras HDCVI'),
(4, 'DVR', 'DVRs'),
(5, 'Monitores', 'Monitores'),
(6, 'NVR - NVS', 'NVR - NVS'),
(7, 'Soportes y Gabinetes', 'Soportes y Gabinetes'),
(8, 'Fuentes y Otros', 'Fuentes y Otros');
...
(1, 1, 1, 'camara domo interior cc345', '2', 'Cámara CMOS 600TVL Varifocal IP66', 10, '1.jpg', 12000, 18000),
(2, 1, 1, 'producto de prueba', '1', 'Cámara CMOS 600TVL Varifocal IP66', 3, '2.jpg', 300, 500),
(3, 1, 1, 'prueba3', '1', 'Camara HDCVI 1MP Exterior IR50m, IP66, 12mm, Smart IR, C/Bracket', 1, '3.jpg', 123, 1234),
...
(5, 1, 'Cámaras Análogas', 'Cámaras Análogas'),
(6, 1, 'Cámaras HDCVI', 'Cámaras HDCVI'),
(7, 1, 'Cámaras IP', 'Cámaras IP'),
(8, 4, '4 a 8 canales ', '4 a 8 canales '),
(9, 4, '16 a 32 Canales', '16 a 32 Canales'),
(10, 5, 'Monitores LCD', 'Monitores LCD'),
(11, 5, 'Monitores LED', 'Monitores LED');
...
--
ALTER TABLE `subcategoria_producto`
  MODIFY `id_subcategoria_producto` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=12;
--
